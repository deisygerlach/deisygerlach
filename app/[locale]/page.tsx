...
export default function Home() {
  ...
  useEffect(() => {
    localStorage.setItem("langDGerlach", currentLocale);
  }, [currentLocale]);
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (typeof (window as unknown as { grecaptcha?: { getResponse: () => string } }).grecaptcha !== "undefined") {
    ...
    if (typeof (window as unknown as { grecaptcha?: { reset: () => void } }).grecaptcha !== "undefined") {
      (window as unknown as { grecaptcha: { reset: () => void } }).grecaptcha.reset();
    }
  };

  const toggleExpandTestimonials = (_id: number) => {
      ...
      <header>
        <nav>
          ...
          <ul className="nav-links" id="navLinks">
            <li>
              <a href="#inicio">{t.header.nav.home}</a>
            </li>
            <li>
              <a href="#servicios">{t.header.nav.services}</a>
            </li>
            <li>
              <a href="#problemas">{t.header.nav.issues}</a>
            </li>
            <li>
              <a href="#testimonios">{t.header.nav.testimonials}</a>
            </li>
            <li>
              <a href="#agendar">{t.header.nav.booking}</a>
            </li>
          </ul>
          <div className="header-controls">
            ...
            <div className="language-selector">
              ...
              >
                <option value="esp" style={{ color: "black" }}>
                  🇪🇸 ES
                </option>
                <option value="eng" style={{ color: "black" }}>
                  🇺🇸 EN
                </option>
                <option value="por" style={{ color: "black" }}>
                  🇧🇷 PT
                </option>
              </select>
            </div>
        ...
        <div className="rainbow-container">
          ...
          <div className="concept-bubbles">
            {t.psychologyRainbow.concepts.map((concept, index) => (
              <div key={index} className="concept-bubble">
                {concept}
              </div>
            ))}
          </div>
